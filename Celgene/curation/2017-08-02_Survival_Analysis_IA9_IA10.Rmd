...
plot(ia10.cluster.D.km, col = "red", xlab = 'Survival (Days)',ylab = 'Proportion of population', main = "Cluster.D MMRF Patients Overall Survival")
...
plot(ia10.cluster.D.km, col = "red", xlab = 'Survival (Days)',ylab = 'Proportion of population', main = "Cluster.D MMRF Patients Progression-free Survival")
lines(ia9.cluster.D.km, col = "blue")
legend("bottomleft", c("IA10", "IA9"), lty = 1, col = c("red", "blue"))
ia9.cluster.D.km
ia10.cluster.D.km
