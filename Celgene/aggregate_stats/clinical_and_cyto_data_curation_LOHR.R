...
d <- broad.sampleinfo
lohr.clinical[["CBC_Platelet"]] <- unlist(lapply(p, FUN = lookup_by_patient, dat = d, field = "Platelets..10.9.L."))
lohr.clinical[["DIAG_Hemoglobin"]] <- unlist(lapply(p, FUN = lookup_by_patient, dat = d, field = "Hemoglobin.mmol.L"))
lohr.clinical[["DIAG_Albumin"]] <- unlist(lapply(p, FUN = lookup_by_patient, dat = d, field = "Serum.albumin..g.dL."))
lohr.clinical[["DIAG_Calcium"]] <- unlist(lapply(p, FUN = lookup_by_patient, dat = d, field = "Calcium.mmol.L"))
lohr.clinical[["DIAG_Creatinine"]] <- unlist(lapply(p, FUN = lookup_by_patient, dat = d, field = "Creatinine.umol.L"))
lohr.clinical[["DIAG_LDH"]] <- unlist(lapply(p, FUN = lookup_by_patient, dat = d, field = "Serum.LDH..U.L."))
lohr.clinical[["DIAG_Beta2Microglobulin"]] <- unlist(lapply(p, FUN = lookup_by_patient, dat = d, field = "Beta2.microglobulin..ug.dL."))
lohr.clinical[["CHEM_CRP"]] <- unlist(lapply(p, FUN = lookup_by_patient, dat = d, field = "CRP..mg.dL."))
lohr.clinical[["IG_IgL_Kappa"]] <- unlist(lapply(p, FUN = lookup_by_patient, dat = d, field = "Serum.free.light.chain.kappa..mg.dL."))
lohr.clinical[["IG_M_Protein"]] <- unlist(lapply(p, FUN = lookup_by_patient, dat = d, field = "M.spike..g.dL."))
lohr.clinical[["IG_IgL_Lambda"]] <- unlist(lapply(p, FUN = lookup_by_patient, dat = d, field = "Serum.free.light.chain.lambda..mg.dL."))
...
lohr.cytogenetic[['t(11;14)']] <- ifelse(unlist(lapply(lohr.clinical$Patient, check_by_patient, 
                                    dat = lohr.supp5, field = "FISH_Translocation", value = "11;14", fixed_pattern = T)), 1,0)
lohr.cytogenetic[['del(17)']]  <-  ifelse(unlist(lapply(lohr.clinical$Patient, check_by_patient, 
                                                        dat = lohr.supp5, field = "FISH_Translocation", value = "17", fixed_pattern = T)), 1,0)
lohr.cytogenetic[['t(14;16)']] <-  ifelse(unlist(lapply(lohr.clinical$Patient, check_by_patient,
                                                        dat = lohr.supp5, field = "FISH_Translocation", value = "14;16", fixed_pattern = T)), 1,0)
lohr.cytogenetic[['t(4;14)']]  <-  ifelse(unlist(lapply(lohr.clinical$Patient, check_by_patient, 
                                                        dat = lohr.supp5, field = "FISH_Translocation", value = "4;14", fixed_pattern = T)), 1,0)
lohr.cytogenetic[["Hyperdiploid"]]  <-as.numeric(unlist(lapply(lohr.clinical$Patient, lookup_by_patient, 
