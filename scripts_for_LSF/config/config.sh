...
export filterBamAlnQuality=${NGS_BINARIES_DIR}/filterBamAlnQuality.pl
export xenograft=${NGS_BINARIES_DIR}/xenograft.pl
...
# the AWS versions point to objects in the S3 bucket which will be used for staging in the AWS environment
        export humanDir=$genomeDatabase/Homo-sapiens/GRCh37.p12
        ...
        export ratDir=$genomeDatabase/Rattus-norvegicus/Rnor_5.0
                export ratDirAWS=${CELGENE_NGS_BUCKET}/data/Genomes//Rattus_norvegicus/Rnor_5.0
...
#########################
# tools and variables that are managed by puppet
#########################
export NGS_PYTHONPATH="/celgene/software/python/lib64/python2.7/site-packages:/celgene/software/python/lib64/python2.6/site-packages:/celgene/software/python/lib64/python2.6/dist-packages:/celgene/software/python/lib64/python2.7/dist-packages:/celgene/software/python/lib/python2.7/site-packages:/celgene/software/python/lib/python2.6/site-packages:/celgene/software/python/lib/python2.6/dist-packages:/celgene/software/python/lib/python2.7/dist-packages"
...
export convertsamforrsembin="/celgene/software/rsem/rsem/rsem-1.2.20/convert-sam-for-rsem"
export rsemscanforpairedendreadsbin="/celgene/software/rsem/rsem-1.2.21/rsem-scan-for-paired-end-reads"
